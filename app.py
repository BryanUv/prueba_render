...
class Trabajador(conexion.Model):
  ...
  # sirve pra indicar lo que vendria a ser el nombre de la tabla en la base de datos
...
def manejo_trabajadores():
  if request.method == 'GET':
    # Retorna una lista de instancia de la calse trabajador
...
class TrabajadorController(Resource):
  def get(self):
    ...
    # NOTA: si yo el paso un listado de informacion entonces adicionalmente agrego la propiedad many=true
